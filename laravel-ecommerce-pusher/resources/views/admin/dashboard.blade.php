<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Admin Dashboard') }} Role : {{ auth('admin')->user()->name }}
        </h2>
    </x-slot>
    <div class="max-w-7xl mx-auto mt-1  pb-1  pr-4 pl-4">
        <div class="mx-auto">
    ...
    <div class="max-w-7xl mx-auto mt-1  pb-1  pr-4 pl-4">
        <div class="mx-auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if (auth('admin')->user()->hasAnyRole(['super_admin', 'admin']))
                        <p>Access Granted</p>
                    @endif
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @role('super_admin', 'admin')
                        <p>This is visible to Super Admin only</p>
                    @endrole
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto mt-1  pb-10  pr-4 pl-4">
        <div class="mx-auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
