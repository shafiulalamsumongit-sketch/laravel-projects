...
<head>
    ...
    <script>
        ...
        var pusher = new Pusher('d8a739c974e9fa04f5eb', {
            cluster: 'ap2'
        });
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    window.Echo.channel('admin-notifications')
                        .listen('.product.added', (e) => {
                           alert('admin-notifications --------iiii-------------------'); console.log(e)
                        })
        ...
        createApp({
            setup() {
                ...
                const validateForm = () => {
                    ...
                    if (!form.short_description.trim()) setError('short_description',
                    ...
                    if (form.seo_description.length > 200) setError('seo_description',
                ...
                const submitsss = async () => {
                    ...
                    axios.post('api/product-save2', formData, {
                            headers: {
                ...
                const submit = async () => {
                    ...
                    axios.post('api/product-save', formData, {
                        ...
                        .catch(error => {
                            ...
                            errors.api_errors = true;
                            console.log("error.response.data------1002----", error.response.data
                                .errors);
                        });
                    loading.value = false
                }
