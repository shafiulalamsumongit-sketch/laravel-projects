        ...
        <div class="mx-auto">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a class='text-blue-600 md:text-green-600 decoration-black  underline hover:decoration-pink-500'
                        target='_blank' href='https://chatgpt.com/c/6997e981-0ce0-8324-a2cc-bea9231f7d6b'>Gmail
                        Send</a><br />
                    <a class='text-blue-600 md:text-green-600  underline hover:decoration-pink-500' target='_blank'
